...
class HomeScreen extends StatelessWidget {
  ...
  Widget _buildStatsCard() {
    ...
    int sessions = 0;
    try {
      streak = OfflineStorageService.getMeditationStreak();
      minutes = OfflineStorageService.getTotalMeditationMinutes();
      sessions = OfflineStorageService.getMeditationSessionCount();
    } catch (_) {}
